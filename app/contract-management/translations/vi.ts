...
export const viTranslations = {
  ...
  contracts: {
    ...
    contractNumberAppendix: 'Số Phụ lục Hợp Đồng',
    phisicalStorageUnit: 'Vị trí lưu trữ',
    ...
    enterContractNumberAppendix: 'Nhập số phụ lục hợp đồng',
    enterPhisicalStorageUnit: 'Nhập vị trí lưu trữ vật lý',
    physicalStorageLocation: 'Vị trí lưu trữ vật lý',
    items: 'hợp đồng',
