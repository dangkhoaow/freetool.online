...
export default function FeaturesSection() {
  // Reduced outer wrapper padding/margin and maximize width
  // Remove max-w-* and container classes from outermost div if present
  const features = [
    {
  ...
  return (
    <div className="container mx-auto max-w-6xl py-0 px-0">
