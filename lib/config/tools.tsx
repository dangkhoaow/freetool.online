...
export const tools: ToolConfig[] = [
  ...
  },
  {
    ...
    description: "Write and run code in a powerful VS Code-like environment directly in your browser with syntax highlighting and multi-language support.",
    icon: <Code className="h-16 w-16" stroke="#007acc" />,
