...
export const shopProducts: ShopProduct[] = [
  {
    ...
    year: "2023",
    images: ["/av-foundation/shop-lotus-pond-original.png", "/av-foundation/shop-lotus-pond-detail-1.png", "/av-foundation/shop-lotus-pond-detail-2.png"],
    inStock: true,
    stockQuantity: 1,
    featured: true,
  ...
  },
  {
    ...
    images: ["/av-foundation/shop-village-life-print.png", "/av-foundation/shop-village-life-frame.png"],
    inStock: true,
    stockQuantity: 12,
    featured: true,
  ...
  },
  {
    ...
    images: ["/av-foundation/shop-art-history-book.png", "/av-foundation/shop-book-interior.png"],
    inStock: true,
    stockQuantity: 25,
    featured: false,
  ...
  },
  {
    ...
    images: ["/av-foundation/shop-lacquer-box.png", "/av-foundation/shop-lacquer-box-open.png", "/av-foundation/shop-lacquer-detail.png"],
    inStock: true,
    stockQuantity: 8,
    featured: false,
  ...
  },
  {
    ...
    year: "2024",
    images: ["/av-foundation/shop-contemporary-abstract.png", "/av-foundation/shop-abstract-detail.png"],
    inStock: true,
    stockQuantity: 1,
    featured: true,
  ...
  },
  {
    ...
    images: ["/av-foundation/shop-silk-scarf.png", "/av-foundation/shop-scarf-detail.png"],
    inStock: true,
    stockQuantity: 15,
    featured: false,
  ...
  },
  {
    ...
    images: ["/av-foundation/shop-mountain-prints-set.png", "/av-foundation/shop-mountain-print-1.png", "/av-foundation/shop-mountain-print-2.png"],
    inStock: true,
    stockQuantity: 20,
    featured: false,
  ...
  },
  {
    ...
    images: ["/av-foundation/shop-tea-set.png", "/av-foundation/shop-tea-set-detail.png", "/av-foundation/shop-tea-ceremony.png"],
    inStock: true,
    stockQuantity: 6,
    featured: false,
