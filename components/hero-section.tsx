...
export default function HeroSection({
  ...
  return (
    <section className="pt-32 pb-16 px-4 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-950">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-6">
              <div className="flex items-center gap-2">
                <ImageIcon size={20} className="text-blue-600 dark:text-blue-400" aria-hidden="true" />
                <span className="text-sm text-gray-600 dark:text-gray-300">Supports batch conversion</span>
              </div>
              <div className="flex items-center gap-2">
                <Zap size={20} className="text-blue-600 dark:text-blue-400" aria-hidden="true" />
                <span className="text-sm text-gray-600 dark:text-gray-300">AI-powered optimization</span>
              </div>
              <div className="flex items-center gap-2">
                <svg
                ...
                <span className="text-sm text-gray-600 dark:text-gray-300">100% secure & private</span>
              </div>
            </div>
          </div>
        </div>
