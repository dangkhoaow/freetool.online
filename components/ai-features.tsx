      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <h3 className="text-xl font-bold mb-2">Intelligent Compression</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <h3 className="text-xl font-bold mb-2">Noise Reduction</h3>
            <p className="text-gray-600">
            ...
            <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Analyzes image content and quality</span>
                </li>
                <li className="flex items-start">
                  <div className="rounded-full bg-green-100 p-1 mr-2 mt-0.5">
                    <Check className="h-3 w-3 text-green-600" />
                  </div>
                  <span className="text-gray-700">Applies targeted enhancements where needed</span>
                </li>
                <li className="flex items-start">
                  <div className="rounded-full bg-green-100 p-1 mr-2 mt-0.5">
                    <Check className="h-3 w-3 text-green-600" />
                  </div>
                  <span className="text-gray-700">Optimizes compression based on content type</span>
                </li>
                <li className="flex items-start">
                  <div className="rounded-full bg-green-100 p-1 mr-2 mt-0.5">
                    <Check className="h-3 w-3 text-green-600" />
                  </div>
                  <span className="text-gray-700">Preserves important metadata when requested</span>
                </li>
              </ul>
            </div>
